{
ExDBGrid Component Suite Version 3.9 - ExColSelect
...
uses
   ...
   StdCtrls, Db, Checklst, ExDBGrid, Buttons, ExtCtrls, ComCtrls, AdvStatusBar;
...
procedure TExColSelectFrm.FormClose(Sender: TObject; var Action: TCloseAction);
var
   i: Integer;
   ContinueUpdate: Boolean;
begin
   if ExColSelectFrm.ModalResult = mrOk then
      begin
...
procedure TExColSelectFrm.OkbtnClick(Sender: TObject);
begin
   ExColSelectFrm.ModalResult := mrOk;
end;

procedure TExColSelectFrm.CancelbtnClick(Sender: TObject);
begin
   ExColSelectFrm.ModalResult := mrCancel;
end;

procedure TExColSelectFrm.ColListDragOver(Sender, Source: TObject; X,
...
procedure TExColSelectFrm.FormDestroy(Sender: TObject);
begin
   ColList.Items.Clear;
   inherited;
end;
