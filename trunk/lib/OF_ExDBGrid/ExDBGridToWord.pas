{
ExDBGrid Component Suite Version 3.9 - ExDBGridToWord
...
uses SysUtils, StdCtrls, Classes, Graphics, Db, Grids, DBGrids, ExDBGrid, ComObj;

procedure GridToWord(Grid: TExDBGrid; FormatNum: integer);
