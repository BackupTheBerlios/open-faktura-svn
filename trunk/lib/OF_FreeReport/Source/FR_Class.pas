...
type
  ...
  TfrSearchDatasetType = (sdtStandard, sdtOnlyOwnerForm, sdtNotSearch);  //01.11.09-ud.
  ...
  protected
    ...
    CurStrNo: Integer;
    Exporting: Boolean;
    //procedure ExpandVariables;  //25.02.08-ud.
  ...
  private
    ...
    FVal: TfrValues;
    FDataset: TfrDataset;
    FDatasetStrList: TStringList;  //01.11.09-ud.
    FGrayedButtons: Boolean;
    FReportType: TfrReportType;
    FSearchDatasetType: TfrSearchDatasetType; //01.11.09-ud.
    FTitle: String;
...
{$ENDIF}
  ...
  published
    ...
    property DatasetStrList: TStringList read FDatasetStrList write FDatasetStrList;  //01.11.09-ud.
    ...
    property SearchDatasetType: TfrSearchDatasetType read FSearchDatasetType write FSearchDatasetType default sdtStandard;  //01.11.09-ud.
...
begin
  ...
  FDatasetStrList := TStringList.Create;  //01.11.09-ud.
end;

destructor TfrReport.Destroy;
begin
  FDatasetStrList.Free;  //01.11.09-ud.
  FVal.Free;
  FVars.Free;
  FEMFPages.Free;
  FEMFPages := nil;
