object JournalVKREForm: TJournalVKREForm
  ...
  object JQuery: TZQuery
    ...
    object JQuerySHOP_ID: TIntegerField
      FieldName = 'SHOP_ID'
      Required = True
    end
    object JQuerySHOP_ORDERID: TIntegerField
      FieldName = 'SHOP_ORDERID'
      Required = True
    end
    object JQuerySHOP_STATUS: TIntegerField
  ...
  object MainMenu1: TJvMainMenu
    ...
    object Ansicht1: TMenuItem
      ...
      object Filter1: TMenuItem
        ...
        object nurbezahlteauslaendischeRechnungen1: TMenuItem
          Tag = 4
          Caption = 'bezahlte ausl'#228'ndische Rechnungen'
          GroupIndex = 1
          RadioItem = True
          OnClick = MenuFilterClick
        end
        object nurunbezahlteauslaendischeRechnungen1: TMenuItem
          Tag = 5
          Caption = 'unbezahlte ausl'#228'ndische Rechnungen'
          GroupIndex = 1
          RadioItem = True
          OnClick = MenuFilterClick
        end
        object alleauslaendischenRechnungen1: TMenuItem
          Tag = 6
          Caption = 'alle ausl'#228'ndischen Rechnungen'
          GroupIndex = 1
          RadioItem = True
          OnClick = MenuFilterClick
        end
        ...
        object Stornorechnungenausblenden1: TMenuItem
          Caption = 'Stornorechnungen ausblenden'
          GroupIndex = 1
          OnClick = Stornorechnungenausblenden1Click
        end
      end
      object N1: TMenuItem
        Caption = '-'
