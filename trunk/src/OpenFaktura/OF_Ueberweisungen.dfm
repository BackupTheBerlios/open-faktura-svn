object UeberweisungForm: TUeberweisungForm
  Left = 346
  Top = 194
  Width = 692
  Height = 565
  Caption = 'UeberweisungForm'
  Color = clBtnFace
    ...
    object PC1: TPageControl
      ...
      object FreigabeTab: TTabSheet
        ...
        object ToolBar2: TToolBar
          ...
          object UeberweisungBtn: TToolButton
            Left = 355
            Top = 0
            AutoSize = True
            Caption = #220'berweisung'
            ImageIndex = 12
            MenuItem = ueberweisung1
          end
        end
      end
      object UeberweisungTab: TTabSheet
        ...
        object ToolBar1: TToolBar
          ...
          object MakeUWBtn: TToolButton
            Left = 283
            Top = 0
            AutoSize = True
            Caption = 'Ausf'#252'hren (DTA erstellen)'
            ImageIndex = 12
            OnClick = MakeUWBtnClick
          end
        end
        ...
        object InfoGB: TOFGroupBox
          ...
          object MahnDatum: TJvDBDateEdit
            Left = 77
            Top = 42
            Width = 81
            Height = 19
      ...
      object VerbuchenTab: TTabSheet
        ...
        object ToolBar3: TToolBar
          ...
          object UWVerbuchBtn: TToolButton
            Left = 173
            Top = 0
            AutoSize = True
            Caption = #220'berweisungen r'#252'ckg'#228'ngig'
            ImageIndex = 13
            OnClick = UWVerbuchBtnClick
          end
          ...
          object UWRestorebtn: TToolButton
            Left = 342
            Top = 0
            AutoSize = True
            Caption = #220'berweisungen verbuchen'
            ImageIndex = 12
            OnClick = UWRestorebtnClick
          end
        end
      end
    end
  ...
  object MainMenu1: TJvMainMenu
    ...
    object Bearbeiten1: TMenuItem
      ...
      object ueberweisung1: TMenuItem
        Caption = #220'berweisung'
        ImageIndex = 12
        ShortCut = 16469
        OnClick = ueberweisung1Click
      end
      object N5: TMenuItem
        Caption = '-'
      end
  ...
  object OPosQuery: TOFZQuery
    ...
    Sql.Strings = (
      'select *'
      'from JOURNAL'
      'where STADIUM>=20 and STADIUM<70 and QUELLE=5 and '
      'STADIUM<>29 and YEAR(RDATUM)>=2000 and BSUMME<>0'
  ...
  object SumTab: TZQuery
    ...
    SQL.Strings = (
      ...
      'TO_DAYS(CURDATE())-TO_DAYS(RDATUM)>SOLL_NTAGE as UEBERFAELLIG,'
      'WAEHRUNG'
      'from JOURNAL'
      
        'where STADIUM>=20 and STADIUM<70 and STADIUM<>29 and QUELLE=5 an' +
        'd YEAR(RDATUM)>=2000 and BSUMME<>0'
      'group by FREIGABE, WAEHRUNG, UEBERFAELLIG')
    Params = <>
    Left = 152
    Top = 216
  end
  object UWTab: TZQuery
    ...
    SQL.Strings = (
      'select *'
      'from JOURNAL'
      'where STADIUM BETWEEN 20 and 69 and STADIUM<>29 and '
      
        'QUELLE=5 and YEAR(RDATUM)>=2000 and BSUMME<>0 and FREIGABE1_FLAG' +
        '="Y"'
      'order by RDATUM, KUN_NAME1, KUN_NAME2')
    Params = <>
    Left = 72
  ...
  object UeberweisTab: TZQuery
    Connection = DM1.DB1
    SQL.Strings = (
      'select * from UEBERWEISUNGEN where ART='#39'U'#39)
    Params = <>
    Left = 280
    Top = 216
  ...
  object VerbuchTab: TZQuery
    ...
    SQL.Strings = (
        ...
        'select * from UEBERWEISUNGEN where JOURNAL_ID=-1 and ART='#39'U'#39' ord' +
        'er by UW_DATUM')
    Params = <>
    Left = 356
    Top = 155
  ...
  object VerbuchDetailTab: TZQuery
    ...
    object VerbuchDetailTabORGNUM: TStringField
      Alignment = taRightJustify
      DisplayLabel = 'Belegnummer'
      DisplayWidth = 12
      FieldName = 'ORGNUM'
    end
